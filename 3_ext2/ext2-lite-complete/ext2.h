...
// extern int ext2_getattr(struct mnt_idmap *, const struct path *, struct kstat *, u32, unsigned int);
extern int ext2_setattr(struct user_namespace *mnt_userns,
                        struct dentry *, struct iattr *);
extern int ext2_getattr(struct user_namespace *mnt_userns,
                        const struct path *, struct kstat *,
